...
@Service
@Properties({
    @Property(name=ResourceProvider.ROOTS, value=PageEditorResourceProvider.ROOT_PATHELEMENT_NAME)
})
public class PageEditorResourceProvider implements ResourceProvider{
	static final String ROOT_PATHELEMENT_NAME = "pageeditor";
	public static final String PAGE_EDITOR_PROVIDER_RESOURCE = "pageeditor.PAGE_EDITOR_PROVIDER_RESOURCE";
	public static final String PAGE_EDITOR_ORIGINAL_RESOURCE_TYPE = "pageeditor.EDITOR_ORIGINAL_RESOURCE";
    private static final String ABS_ROOT = "/" + ROOT_PATHELEMENT_NAME;

    
    /** ResourceProvider interface */
    public Resource getResource(ResourceResolver resolver, HttpServletRequest req, String path) {
        // Synthetic resource for the root, so that /pageeditor works
